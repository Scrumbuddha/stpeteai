...
export const recipes: Recipe[] = [
  ...
  {
    id: "one-pot-pasta-white-beans",
    title: "One-pot pasta with white beans",
    costPerServing: 0.9,
    timeMinutes: 20,
    servings: 4,
    ...
    ingredients: [
      ...
      "1 jar pasta sauce (store brand)",
      "1 can white beans, rinsed",
      "Optional: garlic powder, Italian seasoning, parmesan",
    ],
    steps: [
      "Boil pasta; drain, saving a splash of pasta water.",
      "Stir in sauce, beans, and seasoning; warm 3 minutes.",
      "Loosen with the saved pasta water; top with cheese if you have it.",
    ],
  },
  {
    id: "loaded-baked-potatoes",
    ...
    ingredients: [
      ...
      "Shredded cheese",
      "Optional: salsa, plain yogurt (instead of sour cream), green onion",
    ],
    steps: [
      "Poke potatoes with a fork; microwave 10–12 minutes until soft.",
      "Warm the chili or beans.",
      "Split potatoes and top with beans, cheese, and whatever else you have.",
    ],
  },
  {
    id: "cabbage-sausage-skillet",
    ...
    ingredients: [
      ...
      "1 smoked sausage link, sliced (or 2 cups leftover cooked chicken)",
      "1 onion, sliced",
      "1 tbsp oil, salt, pepper, paprika",
    ],
    steps: [
      "Brown the sausage in oil; set aside.",
      "Cook onion and cabbage in the same pan until soft, about 10 minutes.",
      "Return sausage, season, and serve — good alone or over rice.",
    ],
  },
  {
    ...
    ingredients: [
      "2 ripe bananas (brown-spotted ones work best)",
      "2 eggs",
      "1/2 cup old-fashioned oats",
    ],
    steps: [
      "Mash bananas; whisk in eggs, then stir in oats.",
      "Cook small pancakes in a lightly oiled pan, 2 minutes per side.",
      "Serve with fruit — no syrup needed, the bananas are sweet.",
    ],
  },
];
