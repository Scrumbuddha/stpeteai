...
ROUTINES = [
    ...
    # ── Home (151-175) ───────────────────────────────────────────
    {"id": 151, "title": "Monthly Budget Summary", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Monthly",
     "as_a": "Homeowner", "i_want": "Claude to summarize my household income and expenses",
     "so_that": "I know exactly where my money goes each month"},
    {"id": 152, "title": "Home Maintenance Scheduler", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Monthly",
     "as_a": "Homeowner", "i_want": "Claude to generate a seasonal maintenance checklist",
     "so_that": "I never miss a critical home upkeep task"},
    {"id": 153, "title": "Utility Bill Tracker", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Monthly",
     "as_a": "Homeowner", "i_want": "Claude to compare my utility bills month over month",
     "so_that": "I catch unusual spikes and reduce energy waste"},
    {"id": 154, "title": "Grocery List Generator", "role": "Homeowner",
     "category": "Home", "trigger": "API/On Demand", "frequency": "Weekly",
     "as_a": "Homeowner", "i_want": "Claude to create a weekly grocery list based on planned meals",
     "so_that": "I shop efficiently and reduce food waste"},
    {"id": 155, "title": "Home Warranty Claim Reminder", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Annually",
     "as_a": "Homeowner", "i_want": "Claude to remind me of home warranty expiration dates",
     "so_that": "I renew or file claims before coverage lapses"},
    {"id": 156, "title": "Appliance Recall Checker", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Monthly",
     "as_a": "Homeowner", "i_want": "Claude to check for safety recalls on my registered appliances",
     "so_that": "my family stays safe from defective products"},
    {"id": 157, "title": "Contractor Quote Comparison", "role": "Homeowner",
     "category": "Home", "trigger": "API/On Demand", "frequency": "As needed",
     "as_a": "Homeowner", "i_want": "Claude to compare contractor quotes and flag red flags",
     "so_that": "I hire the best value provider without overpaying"},
    {"id": 158, "title": "Home Inventory Log", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Annually",
     "as_a": "Homeowner", "i_want": "Claude to maintain an inventory of valuables for insurance",
     "so_that": "I can file accurate claims if something is lost or damaged"},
    {"id": 159, "title": "Energy Saving Tips Generator", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Seasonal",
     "as_a": "Homeowner", "i_want": "Claude to generate energy-saving tips based on the season",
     "so_that": "I lower utility bills year-round"},
    {"id": 160, "title": "Mortgage Refinance Monitor", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Monthly",
     "as_a": "Homeowner", "i_want": "Claude to alert me when interest rates drop below my mortgage rate",
     "so_that": "I refinance at the right time"},
    {"id": 161, "title": "Neighborhood Safety Digest", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Weekly",
     "as_a": "Homeowner", "i_want": "Claude to summarize local crime reports and safety alerts",
     "so_that": "I stay informed about my neighborhood"},
    {"id": 162, "title": "HOA Rule Compliance Check", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Quarterly",
     "as_a": "Homeowner", "i_want": "Claude to review planned home projects against HOA rules",
     "so_that": "I avoid fines and disputes"},
    {"id": 163, "title": "Property Tax Assessment Review", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Annually",
     "as_a": "Homeowner", "i_want": "Claude to compare my assessed value against comparable homes",
     "so_that": "I appeal if I am over-assessed"},
    {"id": 164, "title": "Smart Home Device Status", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Weekly",
     "as_a": "Homeowner", "i_want": "Claude to check the status of all smart home devices",
     "so_that": "I catch offline or malfunctioning devices early"},
    {"id": 165, "title": "Family Calendar Sync Summary", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Weekly",
     "as_a": "Homeowner", "i_want": "Claude to compile upcoming family events into a single digest",
     "so_that": "everyone stays coordinated"},
    {"id": 166, "title": "Home Improvement ROI Estimator", "role": "Homeowner",
     "category": "Home", "trigger": "API/On Demand", "frequency": "As needed",
     "as_a": "Homeowner", "i_want": "Claude to estimate the resale ROI of planned renovations",
     "so_that": "I invest in improvements that add real value"},
    {"id": 167, "title": "Insurance Policy Renewal Alert", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Annually",
     "as_a": "Homeowner", "i_want": "Claude to remind me to shop homeowners insurance before renewal",
     "so_that": "I get the best rate each year"},
    {"id": 168, "title": "Meal Plan Weekly Summary", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Weekly",
     "as_a": "Homeowner", "i_want": "Claude to generate a weekly meal plan based on dietary preferences",
     "so_that": "we eat healthier and waste less food"},
    {"id": 169, "title": "Package Delivery Tracker", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Daily",
     "as_a": "Homeowner", "i_want": "Claude to summarize all pending package deliveries",
     "so_that": "I never miss a delivery or leave a package outside"},
    {"id": 170, "title": "Filter & HVAC Replacement Reminder", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Quarterly",
     "as_a": "Homeowner", "i_want": "Claude to remind me when HVAC filters are due for replacement",
     "so_that": "air quality stays healthy and the system runs efficiently"},
    {"id": 171, "title": "Emergency Kit Inventory Check", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Annually",
     "as_a": "Homeowner", "i_want": "Claude to review my emergency kit against a standard checklist",
     "so_that": "my family is prepared for disasters"},
    {"id": 172, "title": "Subscription Audit", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Monthly",
     "as_a": "Homeowner", "i_want": "Claude to list all active subscriptions and flag unused ones",
     "so_that": "I stop paying for services I don't use"},
    {"id": 173, "title": "Neighborhood Event Finder", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Weekly",
     "as_a": "Homeowner", "i_want": "Claude to surface local community events near my address",
     "so_that": "I stay connected to my neighborhood"},
    {"id": 174, "title": "Home Sale Comparables Report", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Quarterly",
     "as_a": "Homeowner", "i_want": "Claude to pull recent home sale prices in my zip code",
     "so_that": "I know my home's current market value"},
    {"id": 175, "title": "Annual Net Worth Snapshot", "role": "Homeowner",
     "category": "Home", "trigger": "Scheduled", "frequency": "Annually",
     "as_a": "Homeowner", "i_want": "Claude to compile my assets and liabilities into a net worth summary",
     "so_that": "I track financial progress year over year"},

    # ── Career (176-200) ─────────────────────────────────────────
    {"id": 176, "title": "Resume Tailoring Assistant", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "Per application",
     "as_a": "Job Seeker", "i_want": "Claude to tailor my resume to match a specific job description",
     "so_that": "my application passes ATS filters and stands out to recruiters"},
    {"id": 177, "title": "Job Board Daily Digest", "role": "Job Seeker",
     "category": "Career", "trigger": "Scheduled", "frequency": "Daily",
     "as_a": "Job Seeker", "i_want": "Claude to surface new job postings matching my criteria",
     "so_that": "I apply to relevant roles before they close"},
    {"id": 178, "title": "Cover Letter Generator", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "Per application",
     "as_a": "Job Seeker", "i_want": "Claude to write a personalized cover letter for each role",
     "so_that": "every application feels tailored, not generic"},
    {"id": 179, "title": "Interview Prep Question Set", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "Before each interview",
     "as_a": "Job Seeker", "i_want": "Claude to generate likely interview questions based on the job posting",
     "so_that": "I walk in confident and prepared"},
    {"id": 180, "title": "LinkedIn Profile Optimizer", "role": "Job Seeker",
     "category": "Career", "trigger": "Scheduled", "frequency": "Monthly",
     "as_a": "Job Seeker", "i_want": "Claude to review my LinkedIn profile and suggest improvements",
     "so_that": "recruiters find and contact me more often"},
    {"id": 181, "title": "Salary Benchmarking Report", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "Per negotiation",
     "as_a": "Job Seeker", "i_want": "Claude to research salary ranges for a specific role and location",
     "so_that": "I negotiate from a position of knowledge"},
    {"id": 182, "title": "Application Tracking Summary", "role": "Job Seeker",
     "category": "Career", "trigger": "Scheduled", "frequency": "Weekly",
     "as_a": "Job Seeker", "i_want": "Claude to summarize the status of all active job applications",
     "so_that": "I follow up at the right time and don't let leads go cold"},
    {"id": 183, "title": "Skills Gap Analysis", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "Per role",
     "as_a": "Job Seeker", "i_want": "Claude to compare my skills against a target job description",
     "so_that": "I know exactly what to learn to qualify"},
    {"id": 184, "title": "Networking Outreach Drafts", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "As needed",
     "as_a": "Job Seeker", "i_want": "Claude to draft personalized outreach messages to contacts",
     "so_that": "I expand my network without sounding spammy"},
    {"id": 185, "title": "Thank You Email After Interview", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "After each interview",
     "as_a": "Job Seeker", "i_want": "Claude to draft a personalized thank-you email",
     "so_that": "I leave a strong impression and stand out post-interview"},
    {"id": 186, "title": "Career Goal Progress Check", "role": "Job Seeker",
     "category": "Career", "trigger": "Scheduled", "frequency": "Monthly",
     "as_a": "Professional", "i_want": "Claude to review my career goals and recent progress",
     "so_that": "I stay on track toward my long-term ambitions"},
    {"id": 187, "title": "Industry News Briefing", "role": "Job Seeker",
     "category": "Career", "trigger": "Scheduled", "frequency": "Weekly",
     "as_a": "Professional", "i_want": "Claude to summarize top news in my target industry",
     "so_that": "I speak knowledgeably in interviews and networking conversations"},
    {"id": 188, "title": "Portfolio Project Ideas", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "As needed",
     "as_a": "Job Seeker", "i_want": "Claude to suggest portfolio projects that demonstrate missing skills",
     "so_that": "I build credibility while filling my skills gap"},
    {"id": 189, "title": "Recruiter Message Screener", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "As received",
     "as_a": "Job Seeker", "i_want": "Claude to evaluate recruiter messages against my career goals",
     "so_that": "I respond to promising opportunities and ignore poor fits"},
    {"id": 190, "title": "Performance Review Prep", "role": "Manager",
     "category": "Career", "trigger": "Scheduled", "frequency": "Quarterly",
     "as_a": "Employee", "i_want": "Claude to compile my accomplishments for my review period",
     "so_that": "I articulate my value clearly during performance reviews"},
    {"id": 191, "title": "Personal Brand Audit", "role": "Job Seeker",
     "category": "Career", "trigger": "Scheduled", "frequency": "Quarterly",
     "as_a": "Professional", "i_want": "Claude to audit my online presence across LinkedIn and GitHub",
     "so_that": "my personal brand reflects my current skills and goals"},
    {"id": 192, "title": "Offer Letter Analyzer", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "Per offer",
     "as_a": "Job Seeker", "i_want": "Claude to review an offer letter and flag unusual clauses",
     "so_that": "I understand what I am agreeing to before signing"},
    {"id": 193, "title": "Mentorship Meeting Prep", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "Before each meeting",
     "as_a": "Mentee", "i_want": "Claude to prepare agenda items and questions for my mentor",
     "so_that": "I make the most of every mentorship session"},
    {"id": 194, "title": "Certification Study Plan", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "Per certification",
     "as_a": "Professional", "i_want": "Claude to create a study schedule for an upcoming certification exam",
     "so_that": "I pass on the first attempt"},
    {"id": 195, "title": "Side Project Monetization Ideas", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "As needed",
     "as_a": "Professional", "i_want": "Claude to suggest ways to monetize my skills outside of employment",
     "so_that": "I build additional income streams"},
    {"id": 196, "title": "Conference Speaker Submission", "role": "Job Seeker",
     "category": "Career", "trigger": "Scheduled", "frequency": "Quarterly",
     "as_a": "Professional", "i_want": "Claude to draft a conference talk proposal based on my expertise",
     "so_that": "I build visibility and authority in my field"},
    {"id": 197, "title": "Weekly Accomplishment Log", "role": "Manager",
     "category": "Career", "trigger": "Scheduled", "frequency": "Weekly",
     "as_a": "Employee", "i_want": "Claude to prompt me to log this week's accomplishments",
     "so_that": "I have evidence ready for reviews and promotions"},
    {"id": 198, "title": "Job Description Red Flag Checker", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "Per posting",
     "as_a": "Job Seeker", "i_want": "Claude to analyze a job description for warning signs",
     "so_that": "I avoid toxic work environments before applying"},
    {"id": 199, "title": "Raise Request Builder", "role": "Manager",
     "category": "Career", "trigger": "API/On Demand", "frequency": "As needed",
     "as_a": "Employee", "i_want": "Claude to help me build a data-backed case for a salary raise",
     "so_that": "I negotiate confidently with my manager"},
    {"id": 200, "title": "Career Pivot Roadmap", "role": "Job Seeker",
     "category": "Career", "trigger": "API/On Demand", "frequency": "As needed",
     "as_a": "Professional", "i_want": "Claude to map out a realistic path to pivot into a new field",
     "so_that": "I make the transition with a clear plan"},

    # ── Education (201-225) ──────────────────────────────────────
    {"id": 201, "title": "Study Schedule Builder", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "Per semester",
     "as_a": "Student", "i_want": "Claude to build a study schedule around my exam dates",
     "so_that": "I cover all material without last-minute cramming"},
    {"id": 202, "title": "Lecture Notes Summarizer", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "After each class",
     "as_a": "Student", "i_want": "Claude to summarize my lecture notes into key concepts",
     "so_that": "I retain information more effectively"},
    {"id": 203, "title": "Essay Outline Generator", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "Per assignment",
     "as_a": "Student", "i_want": "Claude to generate a structured outline for my essay",
     "so_that": "I write faster and with a clearer argument"},
    {"id": 204, "title": "Flashcard Set Creator", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "Per chapter",
     "as_a": "Student", "i_want": "Claude to convert my notes into flashcard question-answer pairs",
     "so_that": "I study more efficiently for exams"},
    {"id": 205, "title": "Research Source Finder", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "Per paper",
     "as_a": "Student", "i_want": "Claude to suggest credible sources for my research topic",
     "so_that": "I build a strong bibliography quickly"},
    {"id": 206, "title": "Citation Formatter", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "Per paper",
     "as_a": "Student", "i_want": "Claude to format my references in the required citation style",
     "so_that": "I avoid losing marks on formatting errors"},
    {"id": 207, "title": "Weekly Assignment Tracker", "role": "Student",
     "category": "Education", "trigger": "Scheduled", "frequency": "Weekly",
     "as_a": "Student", "i_want": "Claude to list all assignments due this week across my courses",
     "so_that": "I never miss a deadline"},
    {"id": 208, "title": "Concept Explainer", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "As needed",
     "as_a": "Student", "i_want": "Claude to explain a confusing concept in plain language",
     "so_that": "I understand it before the exam"},
    {"id": 209, "title": "Practice Problem Generator", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "Per study session",
     "as_a": "Student", "i_want": "Claude to generate practice problems on a topic I am studying",
     "so_that": "I test my understanding before the real exam"},
    {"id": 210, "title": "Group Project Coordinator", "role": "Student",
     "category": "Education", "trigger": "Scheduled", "frequency": "Weekly",
     "as_a": "Student", "i_want": "Claude to draft a status update and task list for my group project",
     "so_that": "the team stays aligned and on schedule"},
    {"id": 211, "title": "Grade Calculator", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "Per grading period",
     "as_a": "Student", "i_want": "Claude to calculate what scores I need to hit my target grade",
     "so_that": "I know exactly what to aim for on remaining work"},
    {"id": 212, "title": "Thesis Statement Refiner", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "Per essay",
     "as_a": "Student", "i_want": "Claude to sharpen my thesis statement for clarity and arguability",
     "so_that": "my essay has a strong central claim"},
    {"id": 213, "title": "Vocabulary Builder", "role": "Student",
     "category": "Education", "trigger": "Scheduled", "frequency": "Daily",
     "as_a": "Student", "i_want": "Claude to teach me five new subject-relevant vocabulary words",
     "so_that": "I expand my academic vocabulary steadily"},
    {"id": 214, "title": "Reading Comprehension Checker", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "Per reading",
     "as_a": "Student", "i_want": "Claude to quiz me on a reading passage to test my comprehension",
     "so_that": "I catch gaps in my understanding before class"},
    {"id": 215, "title": "Scholarship Opportunity Finder", "role": "Student",
     "category": "Education", "trigger": "Scheduled", "frequency": "Monthly",
     "as_a": "Student", "i_want": "Claude to surface scholarships and grants matching my profile",
     "so_that": "I reduce my tuition burden"},
    {"id": 216, "title": "Professor Email Drafter", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "As needed",
     "as_a": "Student", "i_want": "Claude to draft a professional email to my professor",
     "so_that": "I communicate respectfully and get the help I need"},
    {"id": 217, "title": "Exam Anxiety Prep Plan", "role": "Student",
     "category": "Education", "trigger": "Scheduled", "frequency": "Before each exam",
     "as_a": "Student", "i_want": "Claude to build a calm, structured plan for exam week",
     "so_that": "I manage stress and perform at my best"},
    {"id": 218, "title": "Internship Application Tracker", "role": "Student",
     "category": "Education", "trigger": "Scheduled", "frequency": "Weekly",
     "as_a": "Student", "i_want": "Claude to summarize the status of all my internship applications",
     "so_that": "I follow up promptly and maximize my chances"},
    {"id": 219, "title": "Book Report Framework", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "Per book",
     "as_a": "Student", "i_want": "Claude to provide a structured framework for writing my book report",
     "so_that": "I cover all required elements and write with confidence"},
    {"id": 220, "title": "Science Lab Report Writer", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "Per lab",
     "as_a": "Student", "i_want": "Claude to help structure my lab report from raw data and observations",
     "so_that": "I present findings in proper scientific format"},
    {"id": 221, "title": "Language Practice Partner", "role": "Student",
     "category": "Education", "trigger": "Scheduled", "frequency": "Daily",
     "as_a": "Student", "i_want": "Claude to conduct a short conversation exercise in my target language",
     "so_that": "I build fluency through daily practice"},
    {"id": 222, "title": "Course Selection Advisor", "role": "Student",
     "category": "Education", "trigger": "Scheduled", "frequency": "Per semester",
     "as_a": "Student", "i_want": "Claude to recommend courses based on my major requirements and interests",
     "so_that": "I build the most valuable schedule each semester"},
    {"id": 223, "title": "Academic Integrity Checker", "role": "Student",
     "category": "Education", "trigger": "API/On Demand", "frequency": "Per submission",
     "as_a": "Student", "i_want": "Claude to review my work and flag any unintentional paraphrasing issues",
     "so_that": "I submit with confidence knowing my work is original"},
    {"id": 224, "title": "Graduation Requirement Tracker", "role": "Student",
     "category": "Education", "trigger": "Scheduled", "frequency": "Per semester",
     "as_a": "Student", "i_want": "Claude to track completed courses against degree requirements",
     "so_that": "I never miss a required class and graduate on time"},
    {"id": 225, "title": "Learning Goal Weekly Review", "role": "Student",
     "category": "Education", "trigger": "Scheduled", "frequency": "Weekly",
     "as_a": "Student", "i_want": "Claude to review my learning goals and this week's progress",
     "so_that": "I stay intentional and motivated throughout the semester"},
]
